...
pub fn construct_grad<F, D, DM, T>(
...
pub fn kkt_violation<F, D, P, DM, T>(
    dataset: &DatasetBase<DM, T>,
    w: ArrayView1<F>,
    Xw: ArrayView1<F>,
    ws: ArrayView1<usize>,
...
pub fn anderson_accel<F, DM, T, D, P>(
    dataset: &DatasetBase<DM, T>,
    w: &mut Array1<F>,
    Xw: &mut Array1<F>,
    datafit: &D,
...
pub fn cd_epoch_sparse<'a, F, D, P, T>(
